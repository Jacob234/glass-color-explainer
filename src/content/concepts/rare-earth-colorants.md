---
title: rare-earth colorants
mechanism: ions
summary: Lanthanide ions absorb in narrow, host-insensitive pickets rather than broad bands — subtle lilacs and pinks, and glass that genuinely changes color with the light source.
artifacts:
  - id: the-alexandrite-effect
    title: The alexandrite effect
  - id: didymium-eyewear
    title: Didymium eyewear
---

Rare-earth colorants — the lanthanide series elements — work by the same basic principle as [transition metal colorants](../transition-metal-colorants/): ions dissolved in the glass absorbing visible light by electronic transitions. But the physics differs in one crucial way, and that difference defines the whole character of the rare-earth family.
...
**Cerium (Ce³⁺/Ce⁴⁺)** is the family's nearly invisible member: essentially colorless in ordinary light but a strong UV absorber. UV-blocking container glass and ophthalmic lenses exploit this. Cerium is also an oxidizing redox buffer (see [redox in the furnace](../redox/)), and in photosensitive glass formulations it acts as a photosensitizer — absorbing UV and generating electrons that reduce silver ions, enabling the light-triggered development of silver colloids by a process analogous to [silver stain](../silver-stain/).
