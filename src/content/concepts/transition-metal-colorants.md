---
title: transition metal colorants
mechanism: ions
summary: Metal ions dissolved in the glass like dye — cobalt blue, bottle green, amethyst. The color depends on oxidation state, coordination, and the host glass, which is why the same element can give two different colors.
artifacts:
  - id: chartres-blue
    title: Chartres cobalt blue
  - id: beer-bottle-amber
    title: Beer-bottle amber
  - id: wine-bottle-green
    title: Wine-bottle green
---
...
| Colorant | Color | Notes |
|---|---|---|
| Co²⁺ | intense blue | tetrahedral; "smalt"; cobalt blue from ancient Egypt to Bristol blue |
| Cr³⁺ | green | bottle and emerald greens; with iron, the standard wine-bottle green |
| Mn³⁺ | purple / amethyst | also used as a decolorizer (see [redox](../redox/)) |
| Fe²⁺ / Fe³⁺ | blue-green / pale yellow | the ubiquitous impurity tint — the green you see on a window-glass edge |
| Fe³⁺–S²⁻ | amber | the ferri-sulfide chromophore of beer bottles; requires a reduced, sulfur-bearing melt |
| Cu²⁺ | turquoise / blue-green | the Egyptian-faience lineage |
